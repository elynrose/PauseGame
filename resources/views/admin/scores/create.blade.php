    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.scores.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('swipe_left') ? 'is-invalid' : '' }}" type="number" name="swipe_left" id="swipe_left" value="{{ old('swipe_left', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('swipe_right') ? 'is-invalid' : '' }}" type="number" name="swipe_right" id="swipe_right" value="{{ old('swipe_right', '0') }}" step="1">
