    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.games.update", [$game->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $game->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" type="text" name="video_url" id="video_url" value="{{ old('video_url', $game->video_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('time_stamps') ? 'is-invalid' : '' }}" type="text" name="time_stamps" id="time_stamps" value="{{ old('time_stamps', $game->time_stamps) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attempts') ? 'is-invalid' : '' }}" type="number" name="attempts" id="attempts" value="{{ old('attempts', $game->attempts) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $game->active || old('active', 0) === 1 ? 'checked' : '' }}>
