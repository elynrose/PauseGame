    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.games.update", [$game->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.game.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $game->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="video_url" id="video_url" value="{{ old('video_url', $game->video_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="time_stamps" id="time_stamps" value="{{ old('time_stamps', $game->time_stamps) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="attempts" id="attempts" value="{{ old('attempts', $game->attempts) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $game->active || old('active', 0) === 1 ? 'checked' : '' }}>
