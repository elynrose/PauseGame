    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.scores.update", [$score->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="swipe_left" id="swipe_left" value="{{ old('swipe_left', $score->swipe_left) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="swipe_right" id="swipe_right" value="{{ old('swipe_right', $score->swipe_right) }}" step="1">
